...
find ../runtime -name "*.c" -exec clang -target wasm32 -matomics -mbulk-memory -DVECS_NDEBUG -O3 -flto -emit-llvm -c {} -o {}.wasm32.bc \;
find ../runtime -name "*.wasm32.bc"

# Compile the demo for wasm32
find . -name "*.wasm32.bc" -exec rm {} \;
clang -target wasm32 -matomics -mbulk-memory -DVECS_NDEBUG -O3 -flto -emit-llvm -c main.c -o ./main.wasm32.bc
ls ./main.wasm32.bc
...
ls ./demo.o
wasm-ld-18 ./demo.o -o ./demo.wasm --allow-undefined --import-memory --shared-memory --max-memory=67108864 --no-entry --lto-O3 --export=start
ls ./demo.wasm
